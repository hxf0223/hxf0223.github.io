...
ninja.data = [{
    ...
    handler: () => {
      ...
      },{id: "post-ai工具收集及使用笔记-持续更新",
        
          title: "AI工具收集及使用笔记，持续更新",
        
        description: "1. 开发相关Skills1.1. GPU相关 agent-gpu-skills：包含 cutlass、CuTe、CuTeDSL、triton ptx-isa-markdown：PTX指令集的Markdown版本1.2. 通用skills agent-engineer：Google工程师addyosmani写的教程 agent-skills：Google工程师addyosmani写的agent skills2. AI工具收集 BabelDOC: 一款基于AI的文档生成工具，能够自动从代码库中提取信息并生成详细的技术文档，支持多种编程语言和格式。 Pixelle-Video：阿里云团队出品：只需输入一个 主题，AI 全自动短视频引擎–撰写视频文案、生成 AI 配图/视频、合成语音解说、添加背景音乐、一键合成视频。 阿里云百炼平台：阿里云百炼平台。 MinerU：github项目，将pdf/docx等文档转换为markdown。 ComfyUI：AI绘图工具，提供本地APP，以及在线方式。 ComfyUI 全平台下载与安装图文教程 DrawnixDesktop：github 开源白板工具，一体化白板，包含思维导图、流程图、自由画等 DrawnixDesktop 对应博客 graphify：基于AI的知识库生成工具，会搜集目录中的代码、文档、网页等内容，生成知识图谱。代价是需要消耗LLM资源。 Graphify：一条命令，把代码+文档+讨论拉成一张知识图谱 Graphify 操作手册 for Claude Code codebase-memory-mcp：代码仓库知识图谱，对C++不友好，或者说不支持 codebase-memory-mcp 极简完整使用指南 graphify：另外一个代码知识图谱工具，支持C++ code-graph：又一个代码知识图谱，支持C++，3. 其他实用工具 yt-dlp: 一个命令行视频下载工具，支持从YouTube及其他多个网站下载视频，功能强大且持续更新。 YT Downloader (4K/2K/FHD)：另外一个YouTube下载工具，单个Python文件。 Bilidown：B站视频下载工具，支持批量下载和多种格式选择。 Bilibili-Mass-Unfollower: 一个用于批量取消关注Bilibili用户的工具。 ChinaTextBook 中国教材在线平台: 提供小学、初中、高中各学科的教材下载。 Tocify – 快速给PDF添加书签 GitHub地址 Quarkdown：github项目，提供专业的mardown渲染，如论文等。 supervision：Roboflow 团队开源的 CV 后处理工具库...",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2025/AI%E5%B7%A5%E5%85%B7%E6%94%B6%E9%9B%86%E5%8F%8A%E4%BD%BF%E7%94%A8%E7%AC%94%E8%AE%B0/";
