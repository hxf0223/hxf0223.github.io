...
一次 Wavefront 是指一次打包的 load / store 操作。可能由于资源原因，或者地址不对齐等原因，导致 warp 的一次 request 可能需要分为多个 wavefront 来完成。比如，如果发生 bank conflict，则需要多个 wavefront 来完成。
